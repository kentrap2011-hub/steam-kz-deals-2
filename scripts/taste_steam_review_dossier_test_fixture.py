...
def web_dossier(appid, generated, *, title=None, release_year=2020, russian_status="found_and_used"):
    ...
    return {
        ...
        "evidence": {
            ...
            "coverage": {
                "dimensions": [
                    {"dimension": "core_play_mechanics", "state": "covered", "observation_indices": [0]},
                    {"dimension": "controls_game_feel", "state": "not_material_or_not_applicable", "observation_indices": []},
                    {"dimension": "progression_development_unlocks", "state": "not_material_or_not_applicable", "observation_indices": []},
                    {"dimension": "variety_repetition_over_time", "state": "not_material_or_not_applicable", "observation_indices": []},
                    {"dimension": "difficulty_mastery_learning_friction", "state": "not_material_or_not_applicable", "observation_indices": []},
                    {"dimension": "pacing_structure_direction", "state": "not_material_or_not_applicable", "observation_indices": []},
                    {"dimension": "exploration_mission_activity_structure", "state": "not_material_or_not_applicable", "observation_indices": []},
                    {"dimension": "multiplayer_coop_dependence", "state": "not_material_or_not_applicable", "observation_indices": []},
                    {"dimension": "story_characters_identity_hooks", "state": "not_material_or_not_applicable", "observation_indices": []},
                    {"dimension": "recurring_strengths", "state": "covered", "observation_indices": [0]},
                    {"dimension": "recurring_complaints_tradeoffs", "state": "covered", "observation_indices": [0]},
                    {"dimension": "technical_performance_localization_regional", "state": "covered", "observation_indices": [1]},
                ],
