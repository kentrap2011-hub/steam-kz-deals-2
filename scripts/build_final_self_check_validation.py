...
check('taste_is_price_blind', policy['taste_cache']['fingerprint_excludes'] and policy['taste_fit']['price_reviews_discount_never_break_tie'] is True)
check('generic_or_deal_fields_not_taste_evidence', policy['taste_fit']['structured_taste_evaluation']['reviews_discount_price_never_break_tie'] is True)
...
check('wishlist_not_taste_or_ownership', policy['taste_profile']['wishlist_role'] == 'context_only_not_taste_proof' and policy['taste_profile']['wishlist_is_not_ownership_proof'] is True)
