...
4. Exact evidence for each result: provided below.
5. Smallest missing mechanisms: 2, provided below.
6. `IMPLEMENT` task required: `yes`
7. Recommended next step: one bounded `IMPLEMENT` task, specified below.
